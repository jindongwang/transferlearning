...
The procossed .pkl files contains three arraies: 'feature', 'label', 'label_reg'. 'label' refers to the classification label of air quality (for example excellence， good, middle), which is not used in this work and could be ignored. 'label_reg' refers to the prediction.
